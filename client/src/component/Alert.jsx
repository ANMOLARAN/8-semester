  ...
  return (
    ...
    `}>
     {type==="success" && (
        ...
        <p className='teext-xl font-semibold text-primary'>Data Saved</p>
        </div>
     )}
     {type==="danger" && (
        <div className='flex items-center justify-center gap-4'>
        <BsEmojiWink className='text-3xl text-primary'/>
        <p className='teext-xl font-semibold text-primary'>Something went wrong,Please try  again later</p>
        </div>
     )}
    </motion.div>
  )
