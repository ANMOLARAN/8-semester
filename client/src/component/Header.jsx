  ...
  return (
    <header className='flex items-center w-full p-4 md:py-2 md:px-6 bg-primary'>
      <NavLink to={'/'}>
          ...
          className='flex items-center ml-auto cursor-poi gap-2 relative'> 
          <img src={user?.user.imageURL} className='w-12 h-12 min-2-[44px] object-cover rounded-full shadow-lg' alt='' referrerPolicy='no-referrer'/>
          ...
          {isMenu && (
            ...
            exit={{opacity:0, y:50}}
            className='absolute z-10 p-3 top-12 right-0 w-275 gap-2 bg-card shadow-lg backdrop-blur-sm flex flex-col'>
